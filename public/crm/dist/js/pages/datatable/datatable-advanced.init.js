...
window.wordTable = $('#wordTable').DataTable({
    language: {
        "url": "//cdn.datatables.net/plug-ins/1.10.20/i18n/Russian.json"
    },
...
wordTable.column(7).visible(false);

window.syllableTable = $('#syllableTable').DataTable({
    language: {
        "url": "//cdn.datatables.net/plug-ins/1.10.20/i18n/Russian.json"
    },
    createdRow: function ( row, data, index ) {
        $(row).addClass('syllable')
        $(row).attr('data-id',data.id)
    },
    "aaSorting": [],
    "paging": false,
...
window.phraseTable = $('#phraseTable').DataTable({
    language: {
        "url": "//cdn.datatables.net/plug-ins/1.10.20/i18n/Russian.json"
    },
    createdRow: function ( row, data, index ) {
...
phraseTable.column(7).visible(false);
